...
Bot_Name = (Redis:get(TheMero.."Mero:Name:Bot") or "همس")
...
bot.sendAudio(msg.chat_id,msg.id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@LFY5bot")
sleep(1)
